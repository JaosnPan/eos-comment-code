...
namespace eosio {
   ...
   */
   ...
   /**
    * Converts string to uint64_t representation of symbol[将字符串转换为符号的uint64_t表示]
    *
    * @param precision - precision of symbol[符号的精度]
    * @param str - the string representation of the symbol[符号的字符串表示]
    */
