...
extern "C" {
  ...
  /**
   ...
   /**
    * @brief Set the resource limit of an account[设置帐户的资源限制]
    * Set the resource limit of an account[参见设置账户的资源限制]
    * @param account - name of the account whose resource limit to be set[要设置资源限制的账户的名称]
    * @param ram_bytes - ram limit in absolute bytes[要设置资源账户的字节为单位的ram限制]
    * @param net_weight - fractionally proportionate net limit of available resources based on (weight / total_weight_of_all_accounts)
    *                     [基于（weight / total_weight_of_all_accounts）的可用资源的小比例净限制]
    * @param cpu_weight - fractionally proportionate cpu limit of available resources based on (weight / total_weight_of_all_accounts)
    *                     [基于（weight / total_weight_of_all_accounts）的可用资源的小比例cpu限制]
    */
