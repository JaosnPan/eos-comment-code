   ...
   **/
   class block_timestamp {
      public:
         ...
         bool   operator !=( const block_timestamp& t )const   { return slot != t.slot; }
         uint32_t slot;
         static constexpr int32_t block_interval_ms = 5000;
         static constexpr int64_t block_timestamp_epoch = 946684800000ll;  // epoch is year 2000 /** 区块纪元时间 2000年开始,这个值就是unix纪元（1970年到2000年的秒数） */
