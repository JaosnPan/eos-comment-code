...
namespace eosio { namespace chain { namespace resource_limits {
   ...
   /**
    * Every account that authorizes a transaction is billed for the full size of that transaction[授权交易的每个帐户都按照该交易的完整大小进行结算]. This object
    * tracks the average usage of that account[这个对象跟踪该帐户的平均使用情况].
    */
